...
<% String memlogin = (String)session.getAttribute("memlogin");
 	Vector<boardBean> pResult = boardmg.getRecoPostList(); %>
</head>
<body>
<jsp:include page="./header.jsp" />
<section>
	<article>
	<h2><a href="boardreco.jsp" style="color:black;">추천 게시판</a></h2>
		<hr>
		<table class="board">
			<thead style="background-color:#333333; color:white; height : 40px;">
				...
				<tr  style="height: 30px;">
					...
					<td class="btitle"><a href="post.jsp?bno=<%=boardB.getBno()%>&flag=reco"><%=boardB.getBtitle()%></a><span>  [<%=cocnt%>]</span></td>
